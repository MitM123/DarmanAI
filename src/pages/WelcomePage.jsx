        ...
        <div className="mb-8 space-y-4 font-monasans">
          ...
          <div className="space-x-3 flex">
            <label className="cursor-pointer block">
              ...
              <div className="w-64 px-6 py-4 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 border-2 border-slate-300/50 rounded-lg transition-all duration-200 peer-checked:border-indigo-400 peer-checked:bg-gradient-to-br peer-checked:from-indigo-50 peer-checked:via-blue-100 peer-checked:to-slate-100 hover:border-slate-400/60 shadow-sm hover:shadow-md">
